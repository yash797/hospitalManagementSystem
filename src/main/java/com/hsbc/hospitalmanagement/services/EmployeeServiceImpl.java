...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public boolean addEmployee(EmployeeRequest employeeRequest) {
        ...
        int personRows = jdbcTemplate.update(new PreparedStatementCreator() {
            ...
            public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
                PreparedStatement ps = connection.prepareStatement(addPersonQuery, Statement.RETURN_GENERATED_KEYS);
        ...
        return personRows > 0 && employeeRows > 0;
    }

    @Override
    public List<Employee> getAllEmployees() {
        return jdbcTemplate.query(getAllEmployeesQuery, BeanPropertyRowMapper.newInstance(Employee.class));
    }
    ...
    public Person getPerson(String firstName, String lastName, String dob) {
        return jdbcTemplate.queryForObject(getPersonQuery, new Object[]{firstName, lastName, Date.valueOf(dob)}, BeanPropertyRowMapper.newInstance(Person.class));
    }
}